    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RouteEstimateId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteEstimates", x => x.RouteEstimateId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    VehicleSpecificationId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    NominalLPer100Km = table.Column<double>(type: "float", nullable: false),
                    ...
                    AllowedLoad = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleSpecifications", x => x.VehicleSpecificationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QualificationStatus = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QualificationValidUntil = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "VehicleSpecificationId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuelEstimates", x => x.FuelEstimateId);
                    table.ForeignKey(
                        name: "FK_FuelEstimates_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trips_RouteEstimates_RouteEstimateId",
                        column: x => x.RouteEstimateId,
                        principalTable: "RouteEstimates",
                        principalColumn: "RouteEstimateId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LocationPingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationPings", x => x.LocationPingId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuelEstimates_ReservationId",
                table: "FuelEstimates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trips_RouteEstimateId",
                table: "Trips",
                column: "RouteEstimateId",
                unique: true,
